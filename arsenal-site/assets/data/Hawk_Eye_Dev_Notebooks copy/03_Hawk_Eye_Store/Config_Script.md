---
title: Config Script
source_file: Hawk_Eye_Dev_Notebooks copy/03_Hawk_Eye_Store/Config_Script.ipynb
---
...
base_dir = os.path.expanduser("~/Notebooks/Omniversal-Server/Hawk_Eye_Dev_Notebooks/03_Hawk_Eye_Store")
